...
- Bước đang thực hiện: `Không có — P25–P36 đã hoàn tất`
...
| P36 | Lịch 10 phút và giảm commit state | DONE | Cron 10 phút; `last_seen_at` chỉ làm mới khi cũ hơn 1 giờ nên lượt không có gì mới không commit state; test và lượt thật xanh | Người dùng hỏi 5 phút rồi chốt 10 phút. RED 2 test; GREEN 151 test. Run `35816050205` gửi 1 bài và commit state; run `35816106070` ngay sau không có gì mới → `Delivery state is unchanged` |
...
| D021 | Lịch 10 phút (`2-59/10`); `last_seen_at` chỉ làm mới khi cũ hơn 1 giờ | Người dùng chọn 10 phút; tránh commit state mỗi lượt khi không có tin. Thay lịch trong D019/D020 |
...
- `2026-09-23`: P36 DONE; lịch 10 phút, lượt không có tin không commit state.
